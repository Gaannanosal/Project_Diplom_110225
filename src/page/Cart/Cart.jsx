      ...
      <div className="section">
        <div className="titleBtn">
          ...
          <div className="titleBtn__btn">
            <NavLink to={"/"}>
              <div className="titleBtn__btn-elem" style={{ bottom: -24 }}>
                Back to the store
              </div>
            </NavLink>
          </div>
          ...
          <div className="cart__items">
            {cartItem.length === 0 ? (
              <div className="cart__items__shopping">
                <p className="cart__items__shopping-text">
                  Looks like you have no items in your basket currently.
                </p>
                <NavLink to="/products">
                  <button className="cart__items__shopping-btn">
                    Continue Shopping
                  </button>
                </NavLink>
              </div>
                  ...
                  <div className="cart__productCard" key={item.id}>
                    ...
                    >
                      <div className="cart__info-title">
                        <NavLink
                          to={`/product/${item.id}`}
                          className="cart__info-title-link"
                        >
                          {item.title}
                        </NavLink>
                        <div
            ...
            <div className="cart__order">
              ...
              >
                <input
                  ...
                  placeholder="Name"
                  className={
                    "cart__order-forma-input " + (errors.name ? "error" : "")
                  }
                />
                ...
                <input
                  ...
                  placeholder="Email"
                  className={
                    "cart__order-forma-input " + (errors.email ? "error" : "")
                  }
                />
